...
public class ArrayHeapMinPQTests extends BaseTest {
    ...
    class Add3Increasing {
        ...
        @Test
        void sampleStressTest() {
            ExtrinsicMinPQ<Integer> pq = new ArrayHeapMinPQ<>();
            AbstractQueue<Integer> ex = new PriorityQueue<>();
            ...
            int counter = 0;
            while (!pq.isEmpty()) {
                System.out.println(counter + "    Our results    " + pq.removeMin());
                System.out.println(counter + "  Their results    " + ex.remove());
                counter++;
            }
        }
