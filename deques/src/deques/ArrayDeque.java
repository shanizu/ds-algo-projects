...
public class ArrayDeque<T> extends AbstractDeque<T> {
    ...
    // returns new position shifted 'right' by 1, if initial position
    // is 'i'. If 'i' is length - 1, position wraps to front of array.
    ...
    // returns new position shifted 'left' by 1, if initial position
    // is 'i'. If 'i' is 0, position wraps to end of array.
    ...
    private void resize(int capacity) {
        ...
        int i = increment(front, data.length); // should be passing in data.length, not size
